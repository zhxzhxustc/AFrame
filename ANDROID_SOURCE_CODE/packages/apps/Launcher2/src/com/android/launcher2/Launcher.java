...
//        }
    ...
    public void onClick(View v) {
	    ...
	    Log.d("XIAO","Start Activity Result = " + success);
	    ...
	    // XIAO: 10/30/2012
/*	    Log.d("XIAO","About to start intent = " + intent);
	    Log.d("XIAO","intent.getComponent().getClassName() = " + intent.getComponent().getClassName());
	    if(intent.getComponent().getClassName().equals("com.hello_word.com.AframeActivity")){
		final Intent intentCopy = new Intent(intent);
		intentCopy.setAction("android.intent.action.AFRAME");
		intentCopy.removeCategory("android.intent.category.LAUNCHER");
		intentCopy.addCategory("android.intent.category.AFRAME");
		ComponentName component = new ComponentName(intent.getComponent().getPackageName(),
                	    "com.hello_word.com.SecondActivity");
		intentCopy.setComponent(component);
		Log.d("XIAO","About to start intent = " + intentCopy);
		startActivitySafely(intentCopy, tag);
	    }
*/	    // END: 10/30/2012
