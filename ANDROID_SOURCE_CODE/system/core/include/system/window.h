        ...
        int w, int h, int format)
{
	...
	//AMIT
	//LOGE("AMIT - window.h - native_window_set_buffers_geometry(window,..) invoking ANativeWindow->perform(..)");
	//DONE
        ...
        int w, int h)
{
	...
	//AMIT
	//LOGE("AMIT - window.h - native_window_set_buffers_dimensions(window,..) invoking ANativeWindow->perform(..)");
	__android_log_print(ANDROID_LOG_INFO, "AMIT", "AMIT - window.h - native_window_set_buffers_dimensions(window,..) invoking ANativeWindow->perform(..)");
	//DONE
