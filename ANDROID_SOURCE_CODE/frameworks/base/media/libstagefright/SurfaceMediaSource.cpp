...
status_t SurfaceMediaSource::requestBuffer(int slot, sp<GraphicBuffer>* buf) {
	...
	//AMIT
	LOGE("AMIT - status_t SurfaceMediaSource::requestBuffer(int slot, sp<GraphicBuffer>* buf) invoked");
	//DONE
...
status_t SurfaceMediaSource::dequeueBuffer(int *outBuf, uint32_t w, uint32_t h,
	...
	//AMIT
	LOGE("AMIT - status_t SurfaceMediaSource::dequeueBuffer(int *outBuf, uint32_t w, uint32_t h, ... ) invoked");
	//DONE
