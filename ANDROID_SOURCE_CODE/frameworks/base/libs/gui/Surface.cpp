...
void Surface::postAframeBounds(const String8& activityName, 
							int left, int top, int right, int bottom){

	SurfaceTextureClient::postAframeBounds(activityName, left, top, right, bottom);
}
...
status_t Surface::lock(SurfaceInfo* other,  int pairUid, Region* inOutDirtyRegion) {
    ANativeWindow_Buffer outBuffer;
    ...
    status_t err = SurfaceTextureClient::lock(&outBuffer, inOutDirtyBounds, pairUid);
