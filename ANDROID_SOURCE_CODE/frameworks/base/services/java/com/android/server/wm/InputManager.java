...
public class InputManager implements Watchdog.Monitor {
    ...
    //XIAO 11/30/2012
    private static native void nativeRegisterAppInputChannelRegion(InputChannel inputChannel, Region region);
    private static native void nativeRegisterAppInputChannelPkgName(InputChannel inputChannel, String pkgName);
    private static native void nativeRegisterAframePkgNameInputChannel(String pkgName, InputChannel inputChannel);
    //DONE 11/30/2012
    ...
    //XIAO 11/30/2012
    public void registerAppInputChannelRegion(InputChannel inputChannel, Region region){
	nativeRegisterAppInputChannelRegion(inputChannel, region);
    }

    public void registerAppInputChannelPkgName(InputChannel inputChannel, String pkgName){
	nativeRegisterAppInputChannelPkgName(inputChannel, pkgName);
    }

    public void registerAframePkgNameInputChannel(String pkgName, InputChannel inputChannel){
	nativeRegisterAframePkgNameInputChannel(pkgName, inputChannel);
    }
