...
public:
    ...
    //XIAO 11/30/2012
    virtual void nativeRegisterAppInputChannelRegion(const sp<InputChannel>& inputChannel,const SkRegion& region) = 0;
    virtual void nativeRegisterAppInputChannelPkgName(const sp<InputChannel>& inputChannel,const char* pkgName) = 0;
    virtual void nativeRegisterAframePkgNameInputChannel(const char* pkgName, const sp<InputChannel>& inputChannel) = 0;
    //DONE 11/30/2012
};
...
public:
    ...
    //XIAO 11/30/2012
    virtual void nativeRegisterAppInputChannelRegion(const sp<InputChannel>& inputChannel,const SkRegion& region);
    virtual void nativeRegisterAppInputChannelPkgName(const sp<InputChannel>& inputChannel,const char* pkgName);
    virtual void nativeRegisterAframePkgNameInputChannel(const char* pkgName, const sp<InputChannel>& inputChannel);
    //DONE 11/30/2012
