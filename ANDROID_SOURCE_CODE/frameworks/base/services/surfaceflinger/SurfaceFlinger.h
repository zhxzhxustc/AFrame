...
public:
    ...
    /////////////////////////////////////////////////////
    // AMIT - added overload uid argument + pairUid arg
...
private:
   mutable Mutex mAframeLock;

   // 04.22.2013
   //static std::map<const char*, Rect> mActivityAframeBoundsMap;

public:

   void saveAframeBounds(const String8& activityName, 
		   int left, int top, int right, int bottom);

   bool hasAframe(const String8& layerName);
