...
protected:
    ...
    virtual int dequeueBuffer(ANativeWindowBuffer** buffer, uint32_t pairUid);
    ...
    virtual int lock(ANativeWindow_Buffer* outBuffer, ARect* inOutDirtyBounds, int pairUid);
