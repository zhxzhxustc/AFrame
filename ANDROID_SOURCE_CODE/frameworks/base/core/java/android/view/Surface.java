...
public class Surface implements Parcelable {
	...
	//////////////////////////////////////////////////////
    // AMIT - added overload for lockCanvas with pair uid

    /** draw into a surface */
    public Canvas lockCanvas(Rect dirty, int pairUid) throws OutOfResourcesException, IllegalArgumentException {
        /*
         * the dirty rectangle may be expanded to the surface's size, if for
         * instance it has been resized or if the bits were lost, since the last
         * call.
         */
        return lockCanvasNative(dirty, pairUid);
    }
	...
	/*package*/ void postAframeBounds(String activityName, Rect aframeBounds) {

		postAframeBoundsNative(activityName, aframeBounds.left, 
							aframeBounds.top, aframeBounds.right, 
							aframeBounds.bottom );
	}
    ...
    ///////////////////////////////////////////////////
    // AMIT - added overload with uid argument
    
    private native Canvas lockCanvasNative(Rect dirty, int pairUid);
	...
	private native void postAframeBoundsNative(String activityName, 
