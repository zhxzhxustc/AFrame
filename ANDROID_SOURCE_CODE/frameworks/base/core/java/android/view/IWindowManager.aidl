...
interface IWindowManager
{
    ...
    //XIAO 11/30/2012
    void registerAppInputChannelRegion(in InputChannel inputChannel, in Region region);
    void registerAppInputChannelPkgName(in InputChannel inputChannel, String pkgName);
    void registerAframePkgNameInputChannel(String pkgName, in InputChannel inputChannel);
    //DONE 11/30/2012
