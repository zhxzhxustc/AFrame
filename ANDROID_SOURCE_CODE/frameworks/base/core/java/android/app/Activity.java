...
public class Activity extends ContextThemeWrapper
	...
	/*XIAO	10/27/2012
	Log.d("XIAO","Inside Attach call, intent.getComponent().getClassName() = "+ intent.getComponent().getClassName());
	if(intent.getComponent().getClassName().equals("com.hello_word.com.SecondActivity") 
	   || intent.getComponent().getClassName().equals("com.hello_word.com.AframeActivity")){
		mUiThread = Thread.currentThread();
        	Log.d("XIAO","Escape the following code");
        	mMainThread = aThread;
