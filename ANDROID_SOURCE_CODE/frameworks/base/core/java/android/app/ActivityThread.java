...
//XIAO 10/29/2012
    static boolean isSecondActivity = false;
//XIAO 10/29/2012
    ...
    private void handleLaunchActivity(ActivityClientRecord r, Intent customIntent) {
        ...
        if (a != null) {
            ...
            if (!r.activity.mFinished && r.startsNotResumed) {
				...
				Log.d("TTL","Ending Launching process <" + r + ">: " + System.currentTimeMillis());
    ...
    private void handlePauseActivity(IBinder token, boolean finished,
            boolean userLeaving, int configChanges) {
        ActivityClientRecord r = mActivities.get(token);
	Log.d("XIAO","Trying to pause activity = " + token);
        if (r != null) {
            ...
            try {
		Log.d("XIAO","Trying to tell the activity manager we have paused.");
	...
	Log.d("XIAO","About to return from performPauseActivity()");
        return state;
    }
    ...
    private void handleStopActivity(IBinder token, boolean show, int configChanges) {
        ...
        r.activity.mConfigChangeFlags |= configChanges;
//XIAO
   	Log.d("XIAO","Inside handleStopActivity(): r = " + r);
	...
	Log.d("XIAO","Inside handleDestroyActivity()");
        ...
        if (finishing) {
            try {
		Log.d("XIAO","Inform AMS that we have destroyed");
