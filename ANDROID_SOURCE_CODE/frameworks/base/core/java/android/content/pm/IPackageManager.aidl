...
interface IPackageManager {
   ...
   /**
    ...
    String getAppPkgName(String pkgName);
    String getAframePkgName(String pkgName);
    String getAframeName(String pkgName);
    int getAppUid(int uid);
    int getAframeUid(int uid);
    List<String> getAframePermissions(int uid);
    int[] getAframeGids(int uid);
    //Done 11/28/2012
