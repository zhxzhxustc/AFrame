...
public class LinearLayout extends ViewGroup {
    ...
    protected void onDraw(Canvas canvas) {
		...
		//AMIT - log time - used to measure drawing time for linear layout
		//Log.d("AMIT", "LinearLayout.java (Y position : "+ getY() +" ), id(" + getId() + ") - start drawing time : " + System.nanoTime());
		//DONE	

        if (mDivider == null) {

		//Log.d("AMIT", "LinearLayout.java (Y position : "+ getY()  +" ), id(" + getId() + ") - end drawing time : " + System.nanoTime());
            return;
        }
