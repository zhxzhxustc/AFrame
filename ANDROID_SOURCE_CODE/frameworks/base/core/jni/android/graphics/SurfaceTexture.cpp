        ...
        JNIEnv* env, jobject thiz, jint width, jint height)
{
	...
	//AMIT
	LOGD("AMIT - jni/android/graphics/SurfaceTexture.cpp - SurfaceTexture_setDefaultBufferSize(, , w, h) invoking surfaceTexture->setDefaultBufferSize(w = %u,h = %u)", width, height);
	//DONE
